...
{
//    togglekeyboardHeight = [notification.userInfo[UIKeyboardFrameEndUserInfoKey] CGRectValue].size.height;
    // Get the size of the keyboard.
    CGSize keyboardSize = [[[notification userInfo] objectForKey:UIKeyboardFrameBeginUserInfoKey] CGRectValue].size;
    
    //Given size may not account for screen rotation
    togglekeyboardHeight = MAX(keyboardSize.height,keyboardSize.width);
    int width = MAX(keyboardSize.height,keyboardSize.width);
}


#pragma With out scrollview with out tableview
-(void)animateTextField:(UITextField*)textField isUp:(BOOL)isUp View:(UIView *)Myview
{
...
//        [[NSNotificationCenter defaultCenter] addObserver:self selector:@selector(keyboardWillChangeFrame:) name:UIKeyboardWillChangeFrameNotification object:nil];
    ...
    CGFloat bottomEdge = textViewRect.y + textField.frame.size.height;
    ...
    if (isUp)
    {
        ...
        {
            textFieldKeyboardHeight = togglekeyboardHeight - bottomEdge;
...
-(void)animateTextView:(UITextView*)textView isUp:(BOOL)isUp View:(UIView *)Myview
{
